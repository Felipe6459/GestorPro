...
export default function LoginPage() {
  ...
  return <main className="auth-page"><form onSubmit={submit} className="auth-card">
    <div className="brand"><span>GP</span><div><strong>GestorPro</strong><small>2.0</small></div></div>
    <h1>Entrar</h1><p>Acesse seu painel de gestão.</p>
    ...
    <button disabled={loading}>{loading ? 'Entrando...' : 'Entrar no painel'}</button>
